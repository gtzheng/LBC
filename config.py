...
WATERBIRDS_ATTRIBUTE_PATH_VIT_GPT2 = os.path.join(WATERBIRDS_DATA_FOLDER, "vit-gpt2_img_embeddings_thre10_vocab144.pickle")
WATERBIRDS_VOCAB_PATH_VIT_GPT2 = os.path.join(WATERBIRDS_DATA_FOLDER, "vit-gpt2_vocab_thre10_144.pickle")
...
CELEBA_ATTRIBUTE_PATH_VIT_GPT2 = os.path.join(CELEBA_DATA_FOLDER, "vit-gpt2_img_embeddings_thre10_vocab345.pickle")
CELEBA_VOCAB_PATH_VIT_GPT2 = os.path.join(CELEBA_DATA_FOLDER, "vit-gpt2_vocab_thre10_345.pickle")
...
NICO_ATTRIBUTE_PATH_VIT_GPT2 = os.path.join(NICO_DATA_FOLDER, "vit-gpt2_img_embeddings_thre10_vocab199.pickle")
NICO_VOCAB_PATH_VIT_GPT2 = os.path.join(NICO_DATA_FOLDER, "vit-gpt2_vocab_thre10_199.pickle")
...
IMAGENET9_ATTRIBUTE_PATH_VIT_GPT2 = os.path.join(IMAGENET9_DATA_FOLDER, "vit-gpt2_img_embeddings_thre10_vocab442.pickle")
IMAGENET9_VOCAB_PATH_VIT_GPT2 = os.path.join(IMAGENET9_DATA_FOLDER, "vit-gpt2_vocab_thre10_442.pickle")
